		...
		<li><a href="http://www.youtube.com/user/DCLMHQ" class="el-icon-youtube" title="YouTube" target="_blank"></a></li>
			...
			<div id="resurrect-footer-right">
				...
				<a href="mailto:info@deeperlife.ca">info@deeperlife.ca</a>
					...
					<li><span id="resurrect-footer-icon-phone" class="el-icon-phone-alt"></span> <span id="resurrect-footer-phone"> 1-(888) 710 1517</span></li>
				</ul>
						
									
				<div id="resurrect-notice">
					Copyright &copy; 2014 Deeper Christian Life Ministry, Canada.
				</div>
