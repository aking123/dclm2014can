...
<div id="resurrect-container">
  ...
  <?php include 'common/dclmweb-banner.php'; ?>
	...
	<!-- dclm_color_style defined in (common) dclmweb-head -->
...
<div id="resurrect-home-content">
		...
		<div id="resurrect-slider-inner">
			<div class="flexslider">
				<ul class="slides">
					...
					<a href="https://www.youtube.com/watch?v=5qD71MtoY-c" target="_blank">
					<div class="flex-image-container">
					 <img src="images/slides/SuccessCamp_720-960x480.png" alt="" title="" /><div class="flex-play-overlay"></div></a>
					</div>
				    </li>
	...
	<div id="ctcom-home-highlights">
		...
		<div class="resurrect-caption-image resurrect-highlight">
			<a href="sermons/biblestudies/"><img width="600" height="410" src="images/BibleStudy-600x410.jpg" class="resurrect-image" alt="Sermons" />			
			    <!-- <div class="resurrect-caption-image-caption">
				<div class="resurrect-caption-image-title">
					Bible Study								</div>
				<div class="resurrect-caption-image-description">
...
<div id="resurrect-home-bottom-widgets">
	...
	<section class="resurrect-widget resurrect-home-widget widget_ctfw-highlight">
		<div class="resurrect-caption-image resurrect-highlight">
			<img src="images/crusades/November-banner-600x410.jpg" class="resurrect-image" alt="RevivalBanner201408" />			
		</div>
	</section>
	...
	<section class="resurrect-widget resurrect-home-widget widget_ctfw-highlight">
		<div class="resurrect-caption-image resurrect-highlight">
			<a href="resources/online-bible"><img src="images/highlights/biblestudy1-600x410.jpg" class="resurrect-image" alt="Holiness" /></a>
		</div>
