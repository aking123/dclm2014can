...
<head>
  ...
  <?php include dirname(__FILE__) . '/../../common/dclmweb-head.php'; ?>
	<!-- /head_inc -->
   <title>New Convert Resources - Deeper Christian Life Ministry</title>
...
<div id="resurrect-content" class="resurrect-has-sidebar">
	...
	<div id="resurrect-content-inner">
		...
		<div class="ctfw-breadcrumbs"><a href="./">Home</a> > <a href="resources/newconverts">Resources For New Convert</a>
		</div>
		...
		<article class="resurrect-entry-full ctfw-no-image">
			<h1 class="resurrect-entry-title resurrect-main-title">
				New Convert Study Series
			</h1>

		</article>		
		</div>
<?php
include dirname(__FILE__) . '/convert_lessons.php';
$ncTotal = count($nConverts);
for ($ct = 0; $ct < count($nConverts); $ct++):
?>
		<div class="resurrect-content-block resurrect-content-block-close resurrect-clearfix">

		<article class="resurrect-entry-full">
		<div class="resurrect-entry-content resurrect-clearfix">
			<section id="resurrect-loop-after-content" class="resurrect-loop-after-content">
				<article class="resurrect-entry-short resurrect-sermon-short ctfw-no-image">
				<header class="resurrect-entry-header resurrect-clearfix">
				<div class="resurrect-entry-title-meta">
					<h3 class="resurrect-entry-title">
					<a>Study <?php echo ($ct+1) . ': ' . $nConverts[$ct]["Topic"]; ?></a>
					</h3>
					<ul class="resurrect-entry-meta">
						<li class="resurrect-list-buttons">
						<a title="Read Online"><span class="resurrect-button-icon el-icon-book"></span>Read Online</a>
						</li>
						<li class="resurrect-list-buttons">
						<a href="download/?link=<?php echo $nConverts[$ct]["Outline"]; ?>" title="Download Outline"><span class="resurrect-button-icon el-icon-book"></span>	Outline	</a>
					</li>
					</ul>
				</div>
				</header>
