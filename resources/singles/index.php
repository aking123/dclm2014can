...
<head>
  ...
  <?php include dirname(__FILE__) . '/../../common/dclmweb-head.php'; ?>
	<!-- /head_inc -->
   <title>Singles Resources - Deeper Christian Life Ministry</title>
...
<div id="resurrect-content" class="resurrect-has-sidebar">
	...
	<div id="resurrect-content-inner">
		...
		<div class="ctfw-breadcrumbs"><a href="./">Home</a> > <a href="#">Marriage &amp; Family Life</a> > <a href="resources/singles">Resources For Singles</a>
		</div>
		...
		<article class="resurrect-entry-full ctfw-no-image">
			<h1 class="resurrect-entry-title resurrect-main-title">
				Marriage Seminar - Singles
			</h1>

		</article>		
		</div>
<?php
include dirname(__FILE__) . '/singles_series.php';
for ($ct = 0; $ct < count($singles); $ct++) {
 ...
 echo '						<a>Seminar '. ($ct+1) . ': ' . $singles[$ct]["Title"] .'</a>';
 echo '					</h3>';
 ...
 echo '						</li>';
 echo '						<li class="resurrect-list-buttons">';
 echo '						<a href="download/?link=' . $singles[$ct]["Outline"] .'" title="Download Outline"><span class="resurrect-button-icon el-icon-book"></span>Save Outline</a>';
 echo '						</li>';
 echo '					</ul>';
 echo '				</div>';
 echo '				</header>';
