...
if (isset($_SESSION["se_Page"])) {
   ...
   $sermon = array("Sdate" => "20140721",
    ...
    if ($sermon["High"] != "") $sermonFile = $sermon["High"];
    else $sermonFile = $sermon["Low"];
...
';
    ...
    if ($_REQUEST["player"] == "audio") {
	    ...
	    echo '			<video src="'. $sermonFile . '" style="width: 100%; height: 100%;" controls="controls" preload="none"></video>';
    }
    echo '		</div>';
    echo '	</div>';
