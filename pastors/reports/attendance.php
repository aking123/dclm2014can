...
<div class="sx_header">
	...
	<div id="sort_type">
             ...
             <span class="item_selected"><a href="./" onclick="switchTab('attendance'); return false;">Attendance Summary</a></span>
	...
	<div class="newsbox">
	     <div class="n1"><div class="n2"><div class="n3"><div class="n4">
                  <div class="newsbox-title">
                    <a>Bible Study Attendance (2012)</a>
                  </div>
		...
		<table class="tableizer-table" style="margin-left:10%;font-size:0.9em;" border="1" cellpadding="5" summary="Church Location Assets">
			<tr>
			   ...
			   <th rowspan="2" style="width:100px;">AVERAGE (Last Month)</th>
			...
			<tr>
			   ...
			   <th style="min-width:80px;">MAXIMUM</th>
			   <th style="min-width:80px;">MINIMUM</th>
			   <th style="width:80px;">AVERAGE (This Month)</th>
			</tr>
			<?php
