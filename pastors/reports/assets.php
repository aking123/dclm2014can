...
<head>
	...
	function validateForm(itemform) {
		...
		if (!(IsNumeric(day.value)) || !(IsNumeric(mnt.value)) || !(IsNumeric(yr.value))) {
			alert('Please select the day/month/year the item was acquired');
			return false;
		}
...
<div class="sx_header">
	...
	<div id="sort_type">
             ...
             <span class="item_selected"><a href="./" onclick="switchTab('assets'); return false;">Church Assets</a></span>
             <span class="item"><a href="./" onclick="switchTab('attendance'); return false;">Attendance Summary</a></span>
             <span class="item"><a href="./" onclick="switchTab('financial'); return false;">Financial Summary</a></span>
...
<div class="main2">
	...
	<div class="newsbox">
		...
		<table class="tableizer-table" style="margin-left:10%;font-size:0.9em;" border="1" cellpadding="5" summary="Church Location Assets">
			...
			if ($TotAmt > 0.0) {
			  ...
			  echo '<td>'.$TotAmt.'</td><td>'.$TotTax.'</td></tr>';
			}
			else {
			  echo '<tr>';
			  echo '<td>&nbsp;</><td>&nbsp;</td><td>&nbsp;</td>';
	...
	<div class="querybox" style="color: #343a49;padding: 9px 27px 16px;font: 14px/20px Helvetica, Arial, Geneva, sans-serif;">
	<h2 style="margin-left:6em; text-decoration:underline"> Add A New Item </h2>
	...
	<input type="hidden" name="entry" value="new"/>
		...
		<label>
		<span class="labelText">Cost of Item</span>
