...
<head>
	...
	<script type="text/javascript" language="javascript">
	   function validateForm(theform) {
		loc = theform.locname.selectedIndex
		fyr = theform.fyear.selectedIndex
		if ((loc < 1) && (fyr < 1)) {
			alert('Please select a location and/or choose a different year and then click on Change view');
			return false;
		}
...
<div class="sx_header">
	...
	<div id="sort_type">
             ...
             <span class="item"><a href="../index.php?redr=view2">Financial Summary 2</a></span>
...
<div class="main2">
 ...
 <div style="float:right; width:60%; margin-right:2em; margin-top:10px; margin-bottom:10px;text-decoration: none; word-spacing: 0; font: 22px 'Trebuchet MS', 'Lucida Grande', Helvetica, sans-serif; ">
	<span style="float:right;">
	<form method="post" action="../../../externs/churchtables.php" onSubmit="return validateForm(this);">
	<input type="hidden" name="reportType" value="Nat_financial"/>
		<span>View By Location: </span>
		    <select name="locname">
		    <option value="NoLoc">Select Location ...</option>
		    <?php
		      for ($row = 0; $row < count($places)-1; ++$row) {
		        echo '<option value="'.$places[$row].'">'.$places[$row].'</option>';
		      }
		    ?>
		    </select>
		...
		<span>Choose Year: </span>
		    <select name="fyear">
		    <option value="NoYr">....</option><option value="2012">2012</option>
	...
	<div class="newsbox">
	     <div class="n1"><div class="n2"><div class="n3"><div class="n4">
                  <div class="newsbox-title">
                    <a><?php echo $theView .' Income Statement ('.$theYear.')';?></a>
                  </div>
 ...
 <div style="float:left; min-width:90%; margin-right:0.5em;">
	...
	<div class="newsbox">
	     <div class="n1"><div class="n2"><div class="n3"><div class="n4">
                  <div class="newsbox-title">
                    <a><?php echo $theView .' Expenditure Statement (' . $theYear . ')' ;?></a>
                  </div>
