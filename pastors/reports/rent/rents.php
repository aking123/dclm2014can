...
<div class="sx_header">
	...
	<div id="sort_type">
             ...
             <span class="item_selected"><a href="./">Church Rent</a></span>
...
<div class="main2">
	...
	<div class="newsbox">
	     <div class="n1"><div class="n2"><div class="n3"><div class="n4">
             ...
             <div style="padding: 9px 27px 16px; min-height:160px;">
		<table class="tableizer-table" style="margin-left:10%;font-size:0.9em;" border="1" cellpadding="5" summary="Church Rent By Location">
			<tr>
			   <th style="width:80px;"></th>
			   <th style="min-width:100px;">Date</th>
			   <th style="width:100px;">Amount (CAD)</th>
	...
	<h2 style="text-decoration:underline"> Add A New Rent </h2>
	...
	<input type="hidden" name="dbName" value="rents"/>
	<input type="hidden" name="reportType" value="rents"/>
	<input type="hidden" name="entry" value="new"/>
		<label>
		<span class="labelText">Rent (Before Tax)</span>
		<input name="costField" class="text" type="text"  size="10"/>
		</label>
		<label>
		<span class="labelText">Tax Paid on Rent</span>
		<input name="taxField" class="text" type="text"  size="6"/>
		</label>
		<label>
		<span class="labelText">Date Paid (YY-MM-DD):</span>
		    <select name="year">
		        <option>----</option>
		...
		<input class="submit" type="submit" value="Submit Rent" />
	</form>
	</div>
