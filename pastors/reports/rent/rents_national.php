...
<div class="main2">
	...
	<div class="newsbox">
		...
		<table class="tableizer-table" style="margin-left:5%;font-size:0.9em;" border="1" cellpadding="5" summary="Church Rent">
			<tr>
			   <th style="min-width:100px;">Location</th>
			   <th style="min-width:90px;">Date</th>
			   <th style="width:90px;">Rent - Before Tax (CAD)</th>
			   <th style="width:90px;">Tax (CAD)</th>
			   <th style="width:90px;">Total Rent (CAD)</th>
			</tr>
			<?php
			$Totcst = 0.0;
			$TotAmt = 0.0;
